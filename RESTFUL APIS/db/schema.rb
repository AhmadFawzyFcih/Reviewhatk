...
ActiveRecord::Schema.define(version: 20181223155418) do
  ...
  create_table "review_reactions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.integer "review_id"
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.text "profile"
    t.integer "count_reviews", default: 0
    t.integer "count_love", default: 0
    t.integer "count_disLike", default: 0
